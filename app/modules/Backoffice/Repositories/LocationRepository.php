...
class LocationRepository extends BaseRepository
{
	...
	public function getLocationTag($locationId){
		return Location::select('locations.id',\DB::raw('location_tag.tag_id location_id'),\DB::raw('location_tag.tag_id location_tag_id'))
						->join('location_tag', 'locations.id', '=', 'location_tag.location_id')
						->where('location_tag.location_id', '=', $locationId)
						->enabled()
						->get()->toArray();		
	}
	public function getLocationFromTag($locationId){
		return Tag::select('locations.id','location.marker')
