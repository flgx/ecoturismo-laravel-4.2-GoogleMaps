...
function showContextMenu(currentMapLocation) {
    ...
    contextmenuDir.innerHTML = '<ul class="dropdown-menu" role="menu" style="display:block !important;">'
							+  '<li><a onClick="foundMe()" data-toggle="tooltip" data-placement="top" title="Buscar mi posición" id="contextmenu-btn-search-me" href="#"><i style="cursor:pointer" class="fa fa-binoculars"></i></a></li>'
							+ '<li><a onClick="calculateRouteFromMap()" data-toggle="tooltip" data-placement="top" title="&nbsp; Calcular Ruta desde mi ubicación" id="contextmenu-btn-calculate-route" href="#"><i style="cursor:pointer" class="fa fa-road"></i></a></li>'
							+ '</ul>';
...
function addMarkerCluster(index, value) {
	...
	if(images.length > 0) {
  	...
  	contentString += '<a href="assets/images/location/' + oneimage + '" data-lightbox="image-1" id="link-show-location-detail" class=" link-info"><i class="fa fa-picture-o" data-toggle="tooltip" data-placement="top" data-original-title="&nbsp;Ver todas las imagenes"></i></a>' +'<a href="#" id="link-calculate-route-'+value.id+'" onclick="calculateRouteFromMarker(' +value.id+ ', '+ value.lng +', '+ value.lat +')" class=" link-info"><i class="fa fa-road" data-toggle="tooltip" data-placement="top" title="&nbsp;Calcular ruta desde mi posición"></i></a>'+
  	'<a href="#"  id="link-show-location-detail" onclick="getInfoLocation(' +value.id+ ')" class=" link-info"><i class="fa fa-plus" data-toggle="tooltip" data-placement="top" title="&nbsp;Ver más información"></i></a>'+'</div>';
...
function addMarker(index, value) {
	...
	if(images.length > 0) {
  	...
  	contentString += '<ul class="infowindow-items"><li class="nav-item" data-toggle="tooltip" data-placement="left" title="Ver imagenes"><a href="assets/images/location/' + oneimage + '" data-lightbox="image-1" id="link-show-location-detail" class=" link-info"><i class="fa fa-picture-o fa-2x"></i></a></li>' +'<li class="nav-item" data-toggle="tooltip" data-placement="left" title="&nbsp;Calcular ruta desde mi posición"><a href="#" id="link-calculate-route-'+value.id+'" onclick="calculateRouteFromMarker(' +value.id+ ', '+ value.lng +', '+ value.lat +')" class=" link-info"><i class="fa fa-road fa-2x"></i></a></li>'+
  	'<li class="nav-item" data-toggle="tooltip" data-placement="left" title="&nbsp;Ver más información"><a href="#"  id="link-show-location-detail" onclick="getInfoLocation(' +value.id+ ')" class=" link-info"><i class="fa fa-plus fa-2x"></i></a></li>'+'</ul></div>';
   ...
   function createOption(name, distance, num) {
	...
	contentString += '<ul class="infowindow-items"><li class="nav-item" data-toggle="tooltip" data-placement="left" title="Ver imagenes"><a href="assets/images/location/' + oneimage + '" data-lightbox="image-1" id="link-show-location-detail" class=" link-info"><i class="fa fa-picture-ofa-2x"></i></a></li>' +'<li class="nav-item" data-toggle="tooltip" data-placement="left" title="&nbsp;Calcular ruta desde mi posición"><a href="#" id="link-calculate-route-'+location_id+'" onclick="calculateRouteFromMarker(' +location_id+ ', '+ latlng.lng() +', '+ latlng.lat() +')" class=" link-info"><i class="fa fa-road fa-2x"></i></a></li>'+
  	'<li class="nav-item" data-toggle="tooltip" data-placement="left" title="&nbsp;Ver más información"><a href="#"  id="link-show-location-detail" onclick="getInfoLocation(' + id + ')" class=" link-info"><i class="fa fa-plus fa-2x"></i></a></li>'+'</ul></div>';
